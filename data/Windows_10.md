...
Starting with Windows 10 version 2004, Microsoft will require new OEM devices to use 64-bit processors, and will therefore cease the distribution of x86 (32-bit) variants of Windows 10 via OEM channels. The 32-bit variants of Windows 10 will remain available via non-OEM channels, and Microsoft will continue to " feature and security updates on these devices". This was later followed by Windows 11 dropping support for 32-bit hardware altogether, thus making Windows 10 the final version of Windows to have a 32-bit version available.
...
Maximum number of logical processors that Windows 10 supports is: 32 for 32-bit (x86-32) and 1,280 for 64-bit (x86-64).
